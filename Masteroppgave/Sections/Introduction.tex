...
The objective of this thesis is to investigate perturbation-based learning algorithms, with a particular focus on node and weight perturbation, as biologically plausible alternatives to backpropagation.

\begin{itemize}

\item \textbf{Evaluate performance and learning dynamics.} 
Assess how perturbation-based learning methods perform across a range of tasks, both empirically and theoretically. This includes analyzing convergence behavior, stability, and efficiency, and establishing metrics that allow for meaningful comparison with backpropagation.

\item \textbf{Explore improvements within perturbation-based methods.} 
Investigate modifications and extensions to node and weight perturbation aimed at improving their performance, robustness, and scalability.

\item \textbf{Extract insights for alternative learning mechanisms.} 
Examine whether the behavior and properties of perturbation-based learning can provide insights into alternative optimization strategies, potentially informing the development of improved or complementary approaches to backpropagation.
